...
import { Directive, Sanitizer, Input, Output, EventEmitter } from '@angular/core';
var InitMenuDirective = /** @class */ (function () {
    function InitMenuDirective(sanitizer) {
        this.sanitizer = sanitizer;
        this.onChangeMode = new EventEmitter();
    }
    InitMenuDirective.prototype.ngAfterViewInit = function () {
        this.registerApp();
        this.registerMenu();
    };
    InitMenuDirective.prototype.ngOnChanges = function (params) {
    ...
    InitMenuDirective.prototype.registerApp = function () {
        $.app = $.app || {};
        var $body = $('body');
        var $window = $(window);
        ...
        $.app.menu = {
            ...
            changeMenu: function (screen) {
                ...
                var menuWrapper = $('div[data-menu="menu-wrapper"]'), menuContainer = $('div[data-menu="menu-container"]'), menuNavigation = $('ul[data-menu="menu-navigation"]'), megaMenu = $('li[data-menu="megamenu"]'), megaMenuCol = $('li[data-mega-col]'), dropdownMenu = $('li[data-menu="dropdown"]'), dropdownSubMenu = $('li[data-menu="dropdown-submenu"]');
                if (screen == 'sm' || screen == 'xs') {
                    // Change body classes
        ...
        $.app.nav = {
                ...
                function modernMenuExpand() {
                    if ($body.data('menu') == 'vertical-menu-modern') {
                        ...
                        if ($body.hasClass('menu-collapsed')) {
                            var $listItem = $('.main-menu li.menu-collapsed-open'), $subList = $listItem.children('ul');
                    ...
                    if ($body.hasClass('menu-collapsed') && $body.data('menu') == 'vertical-menu-modern') {
                        setTimeout(function () {
                            if ($('.main-menu:hover').length === 0 && $('.navbar-header:hover').length === 0) {
                                ...
                                if ($body.hasClass('menu-collapsed')) {
                                    var $listItem = $('.main-menu li.open'), $subList = $listItem.children('ul');
            ...
            fullSubmenu: function ($menuItem) {
                var $submenu = $menuItem.children('ul:first'), ul = $submenu.clone(true);
                ul.addClass('menu-popout').appendTo('.main-menu-content').css({
                    'top': 0,
                    'position': 'fixed',
                    'height': '100%',
    ...
    InitMenuDirective.prototype.registerMenu = function () {
        var $html = $('html');
        var $body = $('body');
        $(window).on('load', function () {
            ...
            $('.nav-link-search').on('click', function () {
                var $this = $(this), searchInput = $(this).siblings('.search-input');
    ...
    ], InitMenuDirective.prototype, "isNeedChange", void 0);
    tslib_1.__decorate([
        Output(),
        tslib_1.__metadata("design:type", EventEmitter)
    ], InitMenuDirective.prototype, "onChangeMode", void 0);
    InitMenuDirective = tslib_1.__decorate([
        Directive({
            selector: '[appInitMenu]'
        }),
        tslib_1.__metadata("design:paramtypes", [Sanitizer])
    ], InitMenuDirective);
    return InitMenuDirective;
}());
export { InitMenuDirective };
//# sourceMappingURL=init-menu.directive.js.map
...
import { KaraokeLicenseTypeService } from './services/karaoke-license-type.service';
import { InternetLicenseTypeService } from './services/internet-license-type.service';
import { CompanyLicenseTypeService } from './services/company-license-type.service';
...
@NgModule({
  ...
  providers: [
    ...
    MenuService,
    ReportService,
    KaraokeLicenseTypeService,
    InternetLicenseTypeService,
    CompanyLicenseTypeService
  ]
})

...
@Component({
  selector: 'app-report-cultural-services',
  templateUrl: './report-cultural-services.component.html',
  styleUrls: ['./report-cultural-services.component.css']
})
export class ReportCulturalServicesComponent extends BaseComponent implements OnInit {
  ...
  search() {
    this.IsShow = true;
    this.service.ReportCulturalServices(this.criteria).subscribe(r => {
      this.model = r;
    });
  }

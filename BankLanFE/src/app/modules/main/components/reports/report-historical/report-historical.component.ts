...
@Component({
  selector: 'app-report-historical',
  templateUrl: './report-historical.component.html',
  styleUrls: ['./report-historical.component.css']
})
export class ReportHistoricalComponent extends BaseComponent implements OnInit {
  ...
  search() {
    this.IsShow = true;
    this.service.ReportHistoricalSite(this.criteria).subscribe(r => {
      this.model = r;
    });
  }

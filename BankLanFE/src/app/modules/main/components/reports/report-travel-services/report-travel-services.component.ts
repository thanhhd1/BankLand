...
@Component({
  selector: 'app-report-travel-services',
  templateUrl: './report-travel-services.component.html',
  styleUrls: ['./report-travel-services.component.css']
})
export class ReportTravelServicesComponent extends BaseComponent implements OnInit {
  ...
  search() {
    this.IsShow = true;
    this.service.ReportTravelServices(this.criteria).subscribe(r => {
      this.model = r;
    });
  }
